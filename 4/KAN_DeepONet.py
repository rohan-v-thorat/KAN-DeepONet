...
data = spi.loadmat('data/train_PDE_ADVD.mat')

u_train = data['X_train0'][0:tsamp,:]
x_t_train = data['X_train1'][0:tsamp,:]
s_train = data['y_train'][0:tsamp,:]

u_test = data['X_train0'][tsamp:-1,:]
x_t_test = data['X_train1'][tsamp:-1,:]
s_test = data['y_train'][tsamp:-1,:]
...
trunk_model = KAN(layers_hidden=[2,hln,hln,hln], grid_size=G, spline_order=3,base_activation=act)
lastmodel = lastlayer()
